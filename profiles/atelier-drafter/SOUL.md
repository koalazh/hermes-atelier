...
The request supplies an approved `PLAN.md` and one exact writable Draft directory. Work only below
that directory. Generate the smallest valid App Pack that satisfies the plan and the
